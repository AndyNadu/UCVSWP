...
{
    /// <inheritdoc />
    public partial class userclassroom : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Announcement_Classroom_ClassroomID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserClassroomId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GradeAssignmentID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GradeID = table.Column<int>(type: "int", nullable: false),
                    AssignmentID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GradeAssignment", x => x.GradeAssignmentID);
                    table.ForeignKey(
                        name: "FK_GradeAssignment_Assignment_AssignmentID",
                        column: x => x.AssignmentID,
                        principalTable: "Assignment",
                        principalColumn: "AssignmentID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GradeAssignment_Grade_GradeID",
                        column: x => x.GradeID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Announcement_ClassroomID",
                table: "Announcement",
                column: "ClassroomID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GradeAssignment_AssignmentID",
                table: "GradeAssignment",
                column: "AssignmentID");

            migrationBuilder.CreateIndex(
                name: "IX_GradeAssignment_GradeID",
                table: "GradeAssignment",
                column: "GradeID");
